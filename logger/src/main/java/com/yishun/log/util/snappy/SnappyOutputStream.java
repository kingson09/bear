...
import com.yishun.log.util.snappy.buffer.BufferAllocator;
import com.yishun.log.util.snappy.buffer.BufferAllocatorFactory;
import com.yishun.log.util.snappy.buffer.CachedBufferAllocator;
  ...
  public void write(byte[] b, int byteOffset, int byteLength) throws IOException {
    ...
    while (cursor < byteLength) {
      ...
      if (inputCursor < blockSize) {
        System.out.println("last chunksize:" + inputCursor);
      }
